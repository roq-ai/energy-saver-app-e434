...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Energy Manager'];
  const customerRoles: string[] = ['Residential User'];
  const tenantRoles: string[] = ['Energy Manager'];
  const addOns: string[] = ['chat', 'notifications', 'file'];
  const applicationName = `Energy Saver App`;
